...
public class ValidationResult
{
    ...
    public void AddError(string message, string? details = null) { IsValid = false; Messages.Add(ValidationMessage.Error(message, details)); }
    public void AddWarning(string message, string? details = null) { Messages.Add(ValidationMessage.Warning(message, details)); }
    public void AddInfo(string message, string? details = null) { Messages.Add(ValidationMessage.Info(message, details)); }
}
